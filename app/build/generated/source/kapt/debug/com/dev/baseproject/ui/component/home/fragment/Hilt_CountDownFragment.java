...
public abstract class Hilt_CountDownFragment<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CountDownFragment_GeneratedInjector) this.generatedComponent()).injectCountDownFragment(UnsafeCasts.<CountDownFragment>unsafeCast(this));
    }
  }
