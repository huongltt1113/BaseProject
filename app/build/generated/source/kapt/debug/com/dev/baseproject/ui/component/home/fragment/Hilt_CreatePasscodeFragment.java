...
public abstract class Hilt_CreatePasscodeFragment<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreatePasscodeFragment_GeneratedInjector) this.generatedComponent()).injectCreatePasscodeFragment(UnsafeCasts.<CreatePasscodeFragment>unsafeCast(this));
    }
  }
