...
public abstract class Hilt_ChooseSoundEffectFragment<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChooseSoundEffectFragment_GeneratedInjector) this.generatedComponent()).injectChooseSoundEffectFragment(UnsafeCasts.<ChooseSoundEffectFragment>unsafeCast(this));
    }
  }
