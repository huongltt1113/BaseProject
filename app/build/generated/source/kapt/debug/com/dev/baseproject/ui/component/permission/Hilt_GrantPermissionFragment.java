...
public abstract class Hilt_GrantPermissionFragment<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GrantPermissionFragment_GeneratedInjector) this.generatedComponent()).injectGrantPermissionFragment(UnsafeCasts.<GrantPermissionFragment>unsafeCast(this));
    }
  }
