...
public abstract class Hilt_ChooseSoundFragment<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChooseSoundFragment_GeneratedInjector) this.generatedComponent()).injectChooseSoundFragment(UnsafeCasts.<ChooseSoundFragment>unsafeCast(this));
    }
  }
