...
public abstract class Hilt_RecordPassCodeFragment<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecordPassCodeFragment_GeneratedInjector) this.generatedComponent()).injectRecordPassCodeFragment(UnsafeCasts.<RecordPassCodeFragment>unsafeCast(this));
    }
  }
