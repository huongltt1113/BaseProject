...
public class FragmentPlaceHolder4BindingImpl extends FragmentPlaceHolder4Binding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.layoutGuide3, 24);
        sViewsWithIds.put(R.id.iv3, 25);
        sViewsWithIds.put(R.id.label3, 26);
        sViewsWithIds.put(R.id.ivContent3, 27);
    ...
    public FragmentPlaceHolder4BindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 37, sIncludes, sViewsWithIds));
    }
    private FragmentPlaceHolder4BindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
