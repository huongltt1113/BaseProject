...
public abstract class Hilt_TextToVoiceFragment<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TextToVoiceFragment_GeneratedInjector) this.generatedComponent()).injectTextToVoiceFragment(UnsafeCasts.<TextToVoiceFragment>unsafeCast(this));
    }
  }
