...
public abstract class Hilt_ChooseMelodyFragment<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChooseMelodyFragment_GeneratedInjector) this.generatedComponent()).injectChooseMelodyFragment(UnsafeCasts.<ChooseMelodyFragment>unsafeCast(this));
    }
  }
