...
public abstract class Hilt_SettingLanguageFragment<T extends ViewDataBinding, V extends BaseViewModel> extends BaseViewModelFragmentBinding<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SettingLanguageFragment_GeneratedInjector) this.generatedComponent()).injectSettingLanguageFragment(UnsafeCasts.<SettingLanguageFragment>unsafeCast(this));
    }
  }
