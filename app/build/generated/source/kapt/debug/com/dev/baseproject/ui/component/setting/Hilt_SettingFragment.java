...
public abstract class Hilt_SettingFragment<T extends ViewDataBinding, V extends BaseViewModel> extends BaseViewModelFragmentBinding<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SettingFragment_GeneratedInjector) this.generatedComponent()).injectSettingFragment(UnsafeCasts.<SettingFragment>unsafeCast(this));
    }
  }
