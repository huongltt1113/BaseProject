...
public abstract class Hilt_AskLanguageFragment2<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AskLanguageFragment2_GeneratedInjector) this.generatedComponent()).injectAskLanguageFragment2(UnsafeCasts.<AskLanguageFragment2>unsafeCast(this));
    }
  }
