...
public abstract class Hilt_HowToUseFragment<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HowToUseFragment_GeneratedInjector) this.generatedComponent()).injectHowToUseFragment(UnsafeCasts.<HowToUseFragment>unsafeCast(this));
    }
  }
