...
public class FragmentPasscordBindingImpl extends FragmentPasscordBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.recordpassword, 6);
        sViewsWithIds.put(R.id.recordtext, 7);
    }
    // views
    @NonNull
    ...
    public FragmentPasscordBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private FragmentPasscordBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
