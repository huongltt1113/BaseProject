...
public abstract class Hilt_SoundDetailFragment<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SoundDetailFragment_GeneratedInjector) this.generatedComponent()).injectSoundDetailFragment(UnsafeCasts.<SoundDetailFragment>unsafeCast(this));
    }
  }
