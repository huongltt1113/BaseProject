...
public abstract class Hilt_ChooseFunnyFragment<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChooseFunnyFragment_GeneratedInjector) this.generatedComponent()).injectChooseFunnyFragment(UnsafeCasts.<ChooseFunnyFragment>unsafeCast(this));
    }
  }
