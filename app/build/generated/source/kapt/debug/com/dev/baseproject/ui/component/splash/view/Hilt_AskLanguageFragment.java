...
public abstract class Hilt_AskLanguageFragment<T extends ViewDataBinding> extends BaseFragmentBinding<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AskLanguageFragment_GeneratedInjector) this.generatedComponent()).injectAskLanguageFragment(UnsafeCasts.<AskLanguageFragment>unsafeCast(this));
    }
  }
