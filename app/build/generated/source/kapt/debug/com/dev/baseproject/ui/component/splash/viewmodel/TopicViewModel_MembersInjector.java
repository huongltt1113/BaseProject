...
public final class TopicViewModel_MembersInjector implements MembersInjector<TopicViewModel> {
  ...
  public TopicViewModel_MembersInjector(Provider<ApiClient> apiClientProvider,
  ...
  public static MembersInjector<TopicViewModel> create(Provider<ApiClient> apiClientProvider,
      Provider<LocalStorage> localStorageProvider, Provider<FileHelper> fileHelperProvider) {
    return new TopicViewModel_MembersInjector(apiClientProvider, localStorageProvider, fileHelperProvider);
  }

  @Override
  public void injectMembers(TopicViewModel instance) {
