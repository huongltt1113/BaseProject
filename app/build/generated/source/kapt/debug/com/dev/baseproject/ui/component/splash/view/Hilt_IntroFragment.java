...
public abstract class Hilt_IntroFragment<T extends ViewDataBinding, V extends BaseViewModel> extends BaseViewModelFragmentBinding<T, V> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((IntroFragment_GeneratedInjector) this.generatedComponent()).injectIntroFragment(UnsafeCasts.<IntroFragment>unsafeCast(this));
    }
  }
